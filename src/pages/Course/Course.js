                ...
                <div className="max-w-sm rounded overflow-hidden shadow-lg ">
                    ...
                    <div className='flex justify-center border-t-2 items-center mt-3 pb-5 mx-3 bg-white'>
                        ...
                        <div className='flex gap-1'>
                            ...
                            <Link to={`/Course/${id}`}><button className='flex bg-transparent hover:bg-violet-700 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded my-3 ml-3  shadow-md items-center'><AiOutlineDownload></AiOutlineDownload> Download
                            </button></Link>
                        </div>
                    </div>
                </div>
